      ...
      <div class="items-center flex flex-wrap">
        <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
          <!--
            <img
              alt="..."
              class="max-w-full rounded-lg shadow-lg invisible md:visible "
            ...
            <ul class="list-none mt-6 transition duration-500 ease-in-out transform lg:hover:-translate-y-1 lg:hover:scale-110">
              <li class="py-2">
                <div class="flex items-center">
                  <div>
                    <span
                      class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-yellow-600 bg-yellow-200 mr-3"
