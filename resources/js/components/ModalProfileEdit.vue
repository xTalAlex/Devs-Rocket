<template>
  <div>
    ...
    <div v-if="showModal" class="fixed z-50 inset-0 mx-auto max-w-2xl outline-none focus:outline-none px-2 h-screen overflow-scroll scrollbar-thin scrollbar-thumb-gray-900">
